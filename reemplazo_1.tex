...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]  (181, 81) circle [x radius= 9.6, y radius= 9.6]   ;
...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]  (157, 84) circle [x radius= 9.6, y radius= 9.6]   ;
...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]  (201, 86) circle [x radius= 9.6, y radius= 9.6]   ;
\draw (201,86) node  [font=\tiny] [align=left] {7};
% Text Node
\draw    (145, 176) circle [x radius= 9.6, y radius= 9.6]   ;
\draw (145,176) node  [font=\tiny] [align=left] {4};
% Text Node
\draw    (165, 183) circle [x radius= 9.6, y radius= 9.6]   ;
...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ]  (306, 101) circle [x radius= 9.6, y radius= 9.6]   ;
...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]  (339, 112) circle [x radius= 9.6, y radius= 9.6]   ;
...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]  (369, 136) circle [x radius= 9.6, y radius= 9.6]   ;
\draw (369,136) node  [font=\tiny] [align=left] {7};
% Text Node
\draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ]  (412, 157) circle [x radius= 9.6, y radius= 9.6]   ;
\draw (412,157) node  [font=\tiny] [align=left] {4};
% Text Node
\draw  [fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ]  (410, 187) circle [x radius= 9.6, y radius= 9.6]   ;
