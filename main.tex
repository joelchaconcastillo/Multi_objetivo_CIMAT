...
\titlegraphic{
   \includegraphics[width=3cm]{Images/cimat.eps}\hspace*{1.75cm}~%
   \includegraphics[width=3cm]{Images/CONACYT.eps}
}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{Images/clasificacion.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Images/landscape.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Images/Mapping.jpg}
...
\begin{frame}{Ejemplo fase de reemplazo multi-objetivo}
\begin{itemize}
\scriptsize
\item Seleccionar a los $m$-individuos ``extremos''.
\end{itemize}
\begin{figure}[H]
\centering
\input{reemplazo_1.tex}
%\includegraphics[width=0.45\textwidth]{Images/Fase_Remplazo_2.eps}
%\caption{\scriptsize Ejemplo de la distancia generacional y un conjunto de referencia.} 
\end{figure}
\end{frame}
...
\begin{itemize}
\scriptsize
\item Penalizar a los individuos candidatos más cercanos de los individuos ya seleccionados.
\end{itemize}
\begin{figure}[H]
\centering
\input{reemplazo_4.tex}
%\includegraphics[width=0.45\textwidth]{Images/Fase_Remplazo_2.eps}
%\caption{\scriptsize Ejemplo de la distancia generacional y un conjunto de referencia.} 
\end{figure}
\end{frame}
...
\begin{itemize}
\scriptsize
\item De todos los candidatos no penalizados, seleccionar al individuo con mejor distancia de mejoría.
\end{itemize}

\begin{figure}[H]
\centering
\input{reemplazo_5.tex}
%%\includegraphics[width=0.45\textwidth]{Images/Fase_Remplazo_2.eps}
%\caption{\scriptsize Ejemplo de la distancia generacional y un conjunto de referencia.} 
\end{figure}
\end{frame}
...
\begin{itemize}
\scriptsize
\item Para seleccionar a los individuos ``extremos'', el estimador de densidad del espacio objetivo considera el indicador ASF\footcite{deb2015optimality}.
\end{itemize}
