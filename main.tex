...
\begin{mydef}{ \scriptsize Conjunto no dominado}{}
\scriptsize
...
\begin{mydef}{\scriptsize Conjunto Óptimo de Pareto}{}
\scriptsize
%\begin{itemize}
%    \item 
...
\begin{mydef}{\scriptsize Frente de Pareto}{}
\scriptsize
%\begin{itemize}
    %\item 
...
%        \item Se ha demostrado que utlizar el criterio de parada ha mejorado el rendimiento en ejecuciones a largo plazo, principalmente esto se debe a que es relacionado el grado de diversidad con el criterio de paro con lo que se alcanza una balanceo entre exploración e intensificacion.
    \end{itemize}
\end{frame}
...
\begin{itemize}
\item Se considera el problema WFG5 el que es deceptivo.
\item El número de generaciones que se consideraron fue de 
\end{itemize}
